...
- [ ] Each exercise is implemented manually.
- [ ] Each exercise has been committed separately or in small milestones.
- [ ] Code is readable and consistently formatted.
- [ ] Method names clearly describe what they do.
- [ ] Large methods have been refactored into smaller methods.
- [ ] Duplicate logic has been reduced.
- [ ] Edge cases have been tested manually.
- [ ] The final exercise reuses earlier logic where possible.

## Reflection questions

1. Which exercise felt easiest?
2. Which exercise felt hardest?
3. What did I refactor after seeing duplicated code?
4. Which method names did I improve?
5. What Java basics do I feel more confident with now?
6. What do I still need to practice before moving to object modeling?
